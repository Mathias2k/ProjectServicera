...
<%@page import="projeto.DAO.DAO"%>
<%@page import="projeto.domain.Cadastro"%>
...
String sprofissao = request.getParameter("profissao");

Cadastro cad = new Cadastro();
cad.setNome(snome);
cad.setEmail(semail);
cad.setTelefone(stelefone);
cad.setCidade(scidade);
cad.setProfissao(sprofissao);

DAO cadDAO = new DAO();
cadDAO.cadastrar(cad);
%>

<h1>Cadastro salvo com sucesso!</h1> <br><br><br></br></br></br>
