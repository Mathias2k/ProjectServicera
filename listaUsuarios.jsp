...
<head>
<title>Lista de Autonomos</title>
...
<%
	List<Cadastro> listaResultado = (List<Cadastro>) request.getAttribute("listaResultado");
%>
<table border="1">
...
<br></br>
	...
	%>
	<tr> <!-- tabela usuarios -->
		<td width=100><%=u.getNome() %></td>
		<td><%=u.getEmail() %></td>
		<td><%=u.getTelefone() %></td>
		<td><%=u.getCidade() %></td>
		<td><%=u.getProfissao() %></td>
	</tr>
	<%
		}
	%>
